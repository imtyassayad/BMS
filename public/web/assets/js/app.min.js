                ...
                switch (mode) {
                    case "dark": {
                        if (document.getElementById('bs-stylesheet').href.includes('rtl.min.css')) {
                            this.defaultBSStyle.attr('href', '/public/web/assets/css/bootstrap-dark-rtl.min.css');
                            this.defaultAppStyle.attr('href', 'web/assets/css/app-dark-rtl.min.css');
                        }
                        else {
                            this.defaultBSStyle.attr('href', '/public/web/assets/css/bootstrap-dark.min.css');
                            this.defaultAppStyle.attr('href', '/public/web/assets/css/app-dark.min.css');
                        }
                    ...
                    default: {
                        ...
                        if (document.getElementById('bs-stylesheet').href.includes('rtl.min.css')) {
                            this.defaultBSStyle.attr('href', '/public/web/assets/css/bootstrap-rtl.min.css');
                            this.defaultAppStyle.attr('href', '/public/web/assets/css/app-rtl.min.css');
                        }
                        else {
                            this.defaultBSStyle.attr('href', '/public/web/assets/css/bootstrap.min.css');
                            this.defaultAppStyle.attr('href', '/public/web/assets/css/app.min.css');
                        }
